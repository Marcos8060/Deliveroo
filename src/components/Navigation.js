      ...
      <div className=" w-11/12 mx-auto rounded-2xl h-16 px-4 md:flex md:items-center justify-between">
          ...
          <ul className={`md:flex md:items-center md:pl-80 md:pb-2 pb-12 absolute md:static md:bg-black bg-yellow px-10
            ...
            <li className="cursor-pointer md:ml-8 text-xl md:my-0 my-7 text-white">
              <NavLink to="/artists" className={({ isActive }) => isActive ? 'font-bold text-black no-underline' : 'text-white no-underline'}>Home</NavLink>
            </li>
            <li className="cursor-pointer md:ml-8 text-xl md:my-0 my-7">
              <NavLink to="/fans" className={({ isActive }) => isActive ? 'font-bold text-black no-underline' : 'text-white no-underline'}>About</NavLink>
            </li>
            <li className="cursor-ppinter md:ml-8 text-xl md:my-0 my-7">
              <NavLink to="/business" className={({ isActive }) => isActive ? 'font-bold text-black no-underline' : 'text-white no-underline'}>Services</NavLink>
            </li>
            <li className="cursor-pointer md:ml-8 text-xl md:my-0 my-7">
              <NavLink to="/about" className={({ isActive }) => isActive ? 'font-bold text-black no-underline' : 'text-white no-underline'}>Coming Soon</NavLink>
            </li>
          </ul>
