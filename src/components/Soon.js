...
const Soon = () => {
  return (
    <div className='bg-yellow mt-40 md:flex md:items-center md:justify-between md:p-20 p-4'>
        <div className=''>
            <h1 className='font-bold text-black md:text-7xl text-5xl pt-10'>Coming Soon.</h1>
            <h1 className='font-bold md:text-6xl text-4xl text-black'>The<br /> <span className='text-black'>Hottest Burger in </span><span className='text-white'>Town.</span></h1>
