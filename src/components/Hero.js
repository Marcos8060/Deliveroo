      ...
      <div className="bg-white h-100v">
        ...
        <div className="md:flex items-center justify-between">
          <div className="hidden md:block md:w-1/2 w-full mx-auto p-2 mt-20">
            <h1 className="mt-40v">We make the double <br /> Cheesy Burger</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae nihil delectus odio voluptatum magni provident dignissimos fuga maiores veritatis architecto.</p>
          </div>
