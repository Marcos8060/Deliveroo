...
const Delivery = () => {
  return (
    <div className='md:flex md:items-center mx-auto md:p-20 md:mt-0 p-4 mt-40 grid'>
        <div>
         <h1 className='md:text-7xl text-4xl md:font-bold mb-4 text-center'>Express Home <span className='text-yellow'>Delivery</span>.</h1>
